...
class Constants():
    ...
    FRAME_SIZE = 1024    
    LOCAL_LOG_FILEPATH = "/var/log/psec/psec.log"
    ...
    DOM0_REPOSITORY_PATH = "/usr/lib/psec/storage"
    DOMU_REPOSITORY_PATH = "/mnt/storage"    
        
    STR_REPOSITORY = "__repository__"
    FINGERPRINT_METHOD = "md5"
    STR_PSEC_DISK_CONTROLLER = "psec_disk_controller"
    STR_PSEC_INPUT_CONTROLLER = "psec_input_controller"
    STR_IO_BENCHMARK = "psec_io_benchmark"
    STR_PSEC_SYSTEM_CONTROLLER = "psec_system_controller"
